...
The script is used when conducting preliminary data analysis.

The Shapiro-Wilk test is used to test normality, whilst also considering Skewness, Kurtosis and mean vs. median similarity. 
Three methods of detecting outliers are employed: i. Interquartile range method using Tukey's fences, ii. Z-score and iii. Modified Z-score using the median absolute deviation. The method employed is inpart, determined by the normality of the data, and assists in detecting true outliers within the dataframe.
